    ...
    return (
        <Box display="flex" alignItems="center" gap={1}>
            ...
            <StyledSelect
                ...
                displayEmpty
                inputProps={{ 'aria-label': 'Tất cả học phần' }}
            >
                <MenuItem value="">Tất cả học phần</MenuItem>
                <MenuItem value="CT101-Lập trình căn bản A">CT101-Lập trình căn bản A</MenuItem>
                <MenuItem value="CT174-Cấu trúc dữ liệu">CT174-Cấu trúc dữ liệu</MenuItem>
                <MenuItem value="CT177-Phân tích và thiết kế thuật toán">CT177-Phân tích và thiết kế thuật toán</MenuItem>
            </StyledSelect>
